# Scale Down Percentage Lambda Function

## Purpose
This function scales a Kubernetes deployment down by a specified percentage based on the pod name and namespace.
...
- **pod_name** (string, required): The name of the pod to scale down.
- **scale_percentage** (integer, optional): Percentage to scale down by (default is 25).

## Example Requests

1. **Scale down replicas by 25% with a specified operation ID**:
   ```json
   {
  ...
  "body": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "request_id": "a1234b5c-d567-8ef0-9gh1-i2345jklm678",
        "request": "Scale down by 25% for 'my-app-deployment'.",
        "response": "Calculated new replica count: 3."
      },
      {
        "step": "apply_replicas",
        "request_id": "a1234b5c-d567-8ef0-9gh1-i2345jklm678",
        "request": "Set replicas of 'my-app-deployment' to 3.",
        "response": "Successfully scaled deployment 'my-app-deployment' to 3 replicas."
      },
      {
        "step": "summary",
        "operation_id": "d53b5c5d-8473-4a9b-8f0e-e28a9b35d3a7",
        ...
        "scaled_to": 3,
        "scale_percentage": 25,
        "response": "Scaled down 'my-app-deployment' by 25%. New replicas: 3."
      }
    ]
  }
}
