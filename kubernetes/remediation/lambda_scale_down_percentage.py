...
def lambda_handler(event, context):
    ...
    try:
        ...
        new_replicas = max(1, current_replicas - scale_amount)  # Decrease the replicas but ensure at least one remains
        ...
        response_steps.append({
            ...
            "response": f"Scaled down '{deployment_name}' by {scale_percentage}%. New replicas: {new_replicas}."
        })
